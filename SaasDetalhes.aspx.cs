 ...
 */
public partial class _SaasDetalhes: System.Web.UI.Page
{
    ...
    protected void Manipula(Object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            DisplayText.Text = SelectComand(e.Row.Cells[13].Text.ToString(), monitor, nomeDevice, comment, "2", alerta);
            ...
            // ###########################################//
            /*
             *  Limitando quantidade de informação em Mensagem
             */

          //  e.Row.Cells[14].CssClass = "ocultar";
