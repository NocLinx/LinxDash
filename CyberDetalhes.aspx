<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CyberDetalhes.aspx.cs" Inherits="CyberDetalhes" Culture="pt-BR" UICulture="pt-BR" %>
...
<head runat="server">
    <title>Cyber - Versão: 1.1.1</title>
...
ORDER BY dLastInternalStateTime DESC">
        ...
        <asp:SqlDataSource ID="Cyber2" runat="server" ConnectionString="<%$ ConnectionStrings:WhatsUpCyber %>" SelectCommand="SELECT *
FROM (
SELECT DISTINCT DeviceAttribute.sName,
				DeviceAttribute.sValue,
				Device.sDisplayName,
...
-->
                    ...
                    <div style="page: WordSection1;">
                        <p class="MsoNormal" style="margin-bottom: 0cm; margin-bottom: .0001pt; line-height: normal; text-autospace: none; text-align: center; background-color: #5D7B9D;">
                            <span style="font-size: 46pt; font-family: 'Arial Narrow'; color: #FFFFFF; background-color: #5D7B9D; font-weight: lighter;">Cyber</span></p>
                    </div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="Cyber" ForeColor="#333333"  OnRowDataBound="Manipula"  style="text-align: center" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Font-Names="Arial Narrow"
