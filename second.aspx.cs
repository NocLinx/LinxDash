...
public partial class _second : System.Web.UI.Page
{
...
"ORDER BY dLastInternalStateTime DESC";
    ...
    protected void SetaComando()
    {
        ...
        if (setTimerByUser.SelectedItem.Value == "1 Hora")
        {
            ...
            this.Telecom.SelectCommand = SelectCommand("< 119", SQLTelecom);
        ...
        else if (setTimerByUser.SelectedItem.Value == "2 Horas")
        {
            ...
            this.Telecom.SelectCommand = SelectCommand("< 179", SQLTelecom);
        ...
        else if (setTimerByUser.SelectedItem.Value == "3 Horas")
        {
            ...
            this.Telecom.SelectCommand = SelectCommand("< 239", SQLTelecom);
        ...
        else if (setTimerByUser.SelectedItem.Value == "4 Horas")
        {
            ...
            this.Telecom.SelectCommand = SelectCommand("< 299", SQLTelecom);
        ...
        else if (setTimerByUser.SelectedItem.Value == "Todos")
        {
            ...
            this.Telecom.SelectCommand = SelectCommand("> 0", SQLTelecom);
