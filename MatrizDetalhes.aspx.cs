...
*/
           ...
           DisplayText.Text = SelectComand(e.Row.Cells[13].Text.ToString(), monitor, nomeDevice, "2"); // Passando quantidade de horas em que foi inserido a TP para recuperar mesmo se sair do Dash
