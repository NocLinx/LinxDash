...
<head runat="server">
    <title>Dashboard - Versão: 1.1.0</title>
    <style type="text/css">
        .auto-style2
        {
        }
...
ORDER BY dLastInternalStateTime DESC" OnSelecting="Matriz0_Selecting"></asp:SqlDataSource>
...
ORDER BY dLastInternalStateTime DESC">
             ...
             <div class="auto-style4">
                    ...
                    Dashboard - Versão: <a href="ver.html">1.1.0</a><br />
        ...
        <asp:Button ID="Button9" runat="server" title="Clique aqui para mais detalhes" OnClick="Button5_Click" Text="POA" BackColor="#284775" BorderColor="Black" BorderStyle="Groove" BorderWidth="2px" CssClass="auto-style2" Font-Bold="False" Font-Names="Arial Narrow" Font-Size="18pt" ForeColor="White" Height="35px" Width="300px" />
 
                </td>
                  <td  > 
         
        <asp:Button ID="Button10" runat="server" title="Clique aqui para mais detalhes" OnClick="Button6_Click" Text="UBERLÂNDIA" BackColor="#284775" BorderColor="Black" BorderStyle="Groove" BorderWidth="2px" CssClass="auto-style2" Font-Bold="False" Font-Names="Arial Narrow" Font-Size="18pt" ForeColor="White" Height="35px" Width="300px" />
